...
<%
  if (session.getAttribute("user") != null) {
    // Obtendo a lista de IDs dos usuários seguidos a partir do atributo request
    ...
    <div class="card-body">
      <form method="post" action="seguindo">
        ...
        <div class="mb-3">
          ...
          <input type="text" id="followedId" name="followedId" class="form-control" placeholder="Digite o ID do usuário">
        </div>
