...
public class InstallDatabaseServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			service.deleteUserFollowersTable();
			msg += "<h2>Delete table user followers sucessful!</h2>\n";

			service.createUserFollowersTable();
			msg += "<h2>Create table user followers sucessful!</h2>\n";
