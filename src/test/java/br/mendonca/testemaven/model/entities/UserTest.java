...
public class UserTest {
	...
	void testUUID() {
		...
		assertEquals(UUID, user.getUuid(), "O UUID configurado no objeto User nao e o mesmo retornado.");
	...
	void testName() {
		...
		assertEquals(name, user.getName(), "O Name configurado no objeto User nao e o mesmo retornado.");
	...
	void testEmail() {
		...
		assertEquals(email, user.getEmail(), "O E-mail configurado no objeto User nao e o mesmo retornado.");
	...
	void testPassword() {
		...
		assertEquals(pass, user.getPassword(), "O Password configurado no objeto User nao e o mesmo retornado.");
